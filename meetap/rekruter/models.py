...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    mnemo_login = models.CharField(
     _('mnemo_login'), max_length=11, unique=True,
    ...
    other_preference = models.CharField(
     _('other_preference'), max_length=30, blank=True)
    ...
    other_drugs = models.CharField(
     _('other_drugs'), max_length=300, blank=True)
    ...
    other_contact = models.CharField(
     _('other_contact'), max_length=300, blank=True)
    # Sekcja "O mnie"
    about_me = models.CharField(_('about_me'), max_length=1500, blank=True)
    # Zainteresowania w formacie csv
    interests = models.CharField(
     _('interests'), max_length=500, blank=True)
    # Pokaż mi treści dla dorosłych.
    showme_adultcontent = models.BooleanField(
     _('showme_adultcontent'), default=False,)
    # Pokaż moją orientację seksualną.
    showmy_sexorientation = models.BooleanField(
     _('showmy_sexorientation'), default=False,)
    # Pokaż moją rolę w seksie.
    showmy_sexrole = models.BooleanField(
     _('showmy_sexrole'), default=False,)
    # Pokazuj imprezy komercyjne
    showme_commercial = models.BooleanField(
     _('showme_commercial'), default=True,)
    # Pokazuj imprezy typu "Open"
    showme_massevents = models.BooleanField(
     _('showme_massevents'), default=True,)
    # Wysyłaj mi informację o odrzuceniu/akceptacji mojej prośby o doł. do wyd.
    sendme_inv_status_me = models.BooleanField(
     _('sendme_inv_status_me'), default=True,)
    # Wysyłaj mi informację o odrzuceniu/akceptacji zaproszeń na wyd.
    # , które ja wysłałem.
    sendme_inv_status_others = models.BooleanField(
     _('sendme_inv_status_others'), default=True,)
    # Wysyłaj mi wiadomości o otrzymanych przeze mnie zaproszeniach na wyd.
    sendme_invitations = models.BooleanField(
     _('sendme_invitations'), default=True,)
    # Wysyłaj mi wiadomości o tym, że znajomy utworzył nowe wydarzenia.
    sendme_friend_events = models.BooleanField(
     _('sendme_invitations'), default=True,)
    # Wysyłaj mi informację o tym, że ktoś poprosił o dołączenie do mojego wyd.
    sendme_join_request = models.BooleanField(
     _('sendme_invitations'), default=True,)
