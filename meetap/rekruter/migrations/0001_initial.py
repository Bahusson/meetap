    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mnemo_login', models.CharField(max_length=11, unique=True, verbose_name='mnemo_login')),
                ('karma', models.IntegerField(default=0)),
                ('sex_preference', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Straight'), (1, 'Gay'), (2, 'Bi'), (3, 'Trans'), (4, 'Other')], null=True)),
